...
<form action="edit_core.php" method="POST">
               <table style="width:1200px"  class="table table-striped table-bordered text-light">
                <thead>
                    <tr>
                        <th>FIRST NAME</th>
                        <th>LAST NAME</th>
                ...
                if($run_all_dataQuery==true){
                    ...
                    <tbody>
                    <tr>
                        <td><input type="text" value="<?php echo $fetch_allData["fname"]  ?>"  name="fname"></td>
                        <td><input type="text" value="<?php echo $fetch_allData["lname"]  ?>"  name="lname"></td>
                        <td><input type="text" value="<?php echo $fetch_allData["usr_gender"]  ?>"  name="usr_gender"></td>
                        <td><input type="text" value="<?php echo $fetch_allData["usr_prof"]  ?>"  name="usr_prof"></td>
                        <input type="hidden" value="<?php echo $fetch_allData["id"]  ?>"  name="editingId">
                        <td><input type="text" value="<?php echo $fetch_allData["usr_dist"]  ?>"  name="usr_dist"></td>
                        <td><input type="text" value="<?php echo $fetch_allData["usr_mail"]  ?>"  name="usr_mail"></td>
