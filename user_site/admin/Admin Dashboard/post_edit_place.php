...
<h4 class="text-center font-weight-bold">
    <?php 
        if(isset($_REQUEST["data-deleted"])){
            echo "<font color='red'>Data successfully Deleted!</font>";
        }
    ?>
</h4>
<h1 class="text-center text-light"> USERS EDIT</h1>
<form action="post_edit_core.php" method="POST">
               <table style="width:1500px"  class="table table-striped table-bordered text-light">
                ...
                $all_data_query = "SELECT * FROM my_post_tb WHERE id=$eId;";
                ...
                if($run_all_dataQuery==true){
                    ...
                    <tbody>
                    <tr>
                        <td><input class="form-control" type="text" value="<?php echo $fetch_allData["admin_nm"]  ?>"  name="admin_nm"></td>
                        <td><input  class="form-control"type="text" value="<?php echo $fetch_allData["post_title"]  ?>"  name="post_title"></td>
                        <td><input class="form-control" type="text" value="<?php echo $fetch_allData["post_desc"]  ?>"  name="post_desc"></td>
                        <td><input  class="form-control"type="text" value="<?php echo $fetch_allData["post_link"]  ?>"  name="post_link"></td>
                        <input type="hidden" value="<?php echo $fetch_allData["id"]  ?>"  name="editingId">
                        <td><input  class="form-control"type="text" value="<?php echo $fetch_allData["post_url"]  ?>"  name="post_url"></td>
                        <td><input class="form-control" type="text" value="<?php echo $fetch_allData["post"]  ?>"  name="post"></td>
                        <td><input class="form-control" type="submit" name="editButton" value="UPDATE"></td>
