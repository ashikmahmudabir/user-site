...
<h4 class="text-center font-weight-bold">
    <?php 
        if(isset($_REQUEST["cmt_deleted"])){
            echo "<font color='green'>Comment successfully Deleted!</font>";
        }elseif(isset($_REQUEST["cmt_updated"])){
            echo "<font color='green'>Comment Successfully Updated !</font>";
        }
    ?>
</h4>
<h1 class="text-center text-light">ALL COMMENTS HERE</h1>
              <table class="text-light table-bordered table table-striped">             
                <thead>
                    <tr>
                        <th>SL NO</th>
                        <th>USERNAME</th>
                        <th>COMMENTS SUBJECT</th>
                        <th>COMMENTS</th>
                        <th>DATE</th>
                        <th>ACTION</th>
                    </tr>
                ...
                $cmt_dataQuery = "SELECT * FROM usr_cmt_tb;";
                $run_cmt_dataQuery = mysqli_query($connect,$cmt_dataQuery);
                if($run_cmt_dataQuery==true){
                    $slno = 1;
                    while($fetch_allData = mysqli_fetch_array($run_cmt_dataQuery)){
                    ...
                    <tr>
                        ...
                        <td><?php echo $fetch_allData["usr_cmt_mail"]  ?></td>
                        <td><?php echo $fetch_allData["usr_cmt_sbjt"]  ?></td>
                        <td><?php echo $fetch_allData["usr_cmt_cmts"]  ?></td>
                        <td><?php echo $fetch_allData["cmt_signup_date"]  ?></td>
                        <td><a class="text-light" href="edit_cmt.php?edit_id=<?php echo $fetch_allData["id"]  ?>">Edit</a> | <a onclick="return confirm('Are you sure')" class="text-light" href="dlt_cmt_core.php?dlt_id=<?php echo $fetch_allData["id"];   ?> ">Delete</a></td>
                    </tr>
                </tbody>
