        ...
        <div  class="zIndex">
                <div style="background:none;" class="uk-card uk-card-default uk-card-body uk-width-1-1@s uk-light ">
                    ...
                    <li><a href="index.php" class="font-weight-bold pl-0"><span class="uk-margin-small-right" uk-icon="icon: home"></span>ADMIN DASHBOARD</a></li>
                        ...
                        <li class="mt-3 "><a href="#" class="font-size font-weight-bold pl-0"><span class="uk-margin-small-right" uk-icon="icon: comment"></span> USER COMMENTS</a></li>
...
<h1 class="text-center text-light">ALL USERS MANGEMENT</h1>
               ...
               <table style="width:1500px"  class="table table-striped table-bordered text-light">
                ...
                if($run_all_dataQuery==true){
                    ...
                    <tr>
                        ...
                        <td><a class="text-light" href="edit_place.php?edit_id=<?php echo $fetch_allData["id"]  ?>">Edit</a> | <a onclick="return confirm('Are you sure')" class="text-light" href="delete_core.php?dlt_id=<?php echo $fetch_allData["id"];   ?> ">Delete</a></td>
                    </tr>
                </tbody>
