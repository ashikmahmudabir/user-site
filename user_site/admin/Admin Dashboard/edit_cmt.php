...
<h1 class="text-center text-light"> COMMENTS EDIT</h1>
<form action="edit_cmt_core.php" method="POST">
               <table style="width:1500px"  class="table table-striped table-bordered text-light">
                ...
                if(isset($_REQUEST["edit_id"])){
                    $cmtEditId =  $_REQUEST["edit_id"];   
                
                
                          
                $all_cmt_query = "SELECT * FROM usr_cmt_tb WHERE id=$cmtEditId;";
                $run_all_cmt_query = mysqli_query($connect,$all_cmt_query);
                if($run_all_cmt_query==true){
                    $slno = 1;
                    while($fetch_allData = mysqli_fetch_array($run_all_cmt_query)){
                    ?>  
                    <tbody>
                    <tr>
                        <td><input class="form-control" type="text" value="<?php echo $fetch_allData["usr_cmt_mail"]  ?>"  name="usr_cmt_mail"></td>
                        <td><input  class="form-control"type="text" value="<?php echo $fetch_allData["usr_cmt_sbjt"]  ?>"  name="usr_cmt_sbjt"></td>
                        <td><input class="form-control" type="text" value="<?php echo $fetch_allData["usr_cmt_cmts"]  ?>"  name="usr_cmt_cmts"></td>
